...
public class EditFileDocumentQueryInputValidatorTests : AiTrainerTestBase
{
    private readonly EditFileDocumentQueryInputValidator _validator;

    public EditFileDocumentQueryInputValidatorTests()
    {
        _validator = new EditFileDocumentQueryInputValidator();
    }
    ...
    {
        // Arrange
        var model = _fixture.Build<EditFileDocumentQueryInput>()
    ...
    public void Should_Not_Have_Error_When_All_Properties_Are_Valid()
    {
        // Arrange
        var model = _fixture.Build<EditFileDocumentQueryInput>()
            .With(x => x.ChangeRequest, "Please update this document")
            .With(x => x.FileDocumentId, Guid.NewGuid())
            .Create();
